...
class GBMRatioCalibration(ProcessModel):
    ...
    def set_input(self, model):
        ...
        self.rhoShR = model.rhoShR
        self.rhoStR = model.rhoStR
        self.molFt = model.molFt
        self.molFn = model.molFkappa[0]
    ...
    def get_output(self):
        ...
        if self.flag_proliferation:
            ...
            H2 = df.conditional(df.gt(cFt, self.cFt_ms), 1.0, 0.0)  # mobile cancer cells above threshold
            ...
            hat_St_Fn_gain = H1 * H2 * H4 * fac_cFn_min * fac_max_nSt
