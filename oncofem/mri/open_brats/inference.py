...
from oncofem.mri.open_brats.models import get_norm_layer
from .tta import apply_simple_tta
from .utils import reload_ckpt_bis

class Inference:
    def __init__(self):
        self.config = "/home/marlon/Software/OncoFEM/oncofem/mri/tseg/open_brats/default_nn/default_nn.yaml"
        self.devices = "0"
        self.on = "val"
        self.tta = bool
        self.seed = 16111990
