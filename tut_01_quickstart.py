...
from oncofem.utils.fem import BoundingBox, mark_facet
import dolfin as df
########################################################################################################################
# INPUT
#
...
study = of.structure.Study("tut_01_patient")
subj_1 = study.create_subject("Subject_1")
state_1 = subj_1.create_state("init_state")
path = of.ONCOFEM_DIR + "/data/brats/BraTS20_Training_001_"
...
mri = of.structure.MRI(state=state_1)
